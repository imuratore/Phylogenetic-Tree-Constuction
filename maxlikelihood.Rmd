...
#Due to the nature of sequencing techniques, sometimes sequences have poorer quality in a particular area such as the very beginning or very end. There, we will plot the frequence of non-ATCG bases over their position in the sequence. 
...
#Due to the majority of the missing data appearing in the start of the sequence, we can infer that this was caused to differences in overall length between strains due to sequence divergence
